...
public class Test {
    private static void createOrder(IOrderDAO orderDAO, long capacity, Class class_, String start_date, String end_date, long user_id) {
        try {
            Date start_date1 = new SimpleDateFormat("yyyy-MM-dd").parse(start_date);
            Date end_date1 = new SimpleDateFormat("yyyy-MM-dd").parse(end_date);
            Order order1 = new Order(capacity, class_, start_date1, end_date1, Status.pending, user_id);
    ...
    private static void OrderDAO_Test() throws SQLException {
        ...
        createOrder(orderDAO, 3, Class.business, "10-05-2022", "12-05-2022", 1);
        createOrder(orderDAO, 2, Class.economy, "20-06-2022", "25-06-2022", 1);
